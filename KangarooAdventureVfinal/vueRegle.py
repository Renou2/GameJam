...
largBut=80
hautBut=30
fond = pygame.image.load('fonds/fondpay.png').convert_alpha()
frame.blit(fond, (0,0))
pygame.display.flip()
...
entrerRegles0 = smallText.render("Dans ce jeu, votre but sera d'accumuler un maximum", 1, (10,10,10))
entrerRegles1 = smallText.render("de points dans les différents mondes. Vous aurez ", 1, (10,10,10))
entrerRegles2 = smallText.render("trois minutes pour collecter un maximum de pièces et ", 1, (10,10,10))
entrerRegles3 = smallText.render("de points par niveau et ainsi passez au niveau suivant.", 1, (10,10,10))
