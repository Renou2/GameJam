...
def timer(horloge,o):
    ...
    if total_seconds < 0:
        ...
        if len(sys.argv)>1:
            nomj=sys.argv[1]
        commande=commande+" vueFinNiveau.py " +nomj+" "+str(o.score)+" "+str(o.compteurpiece)+" "+"1"
        pygame.quit()
        os.system(commande)
        quit()
...
o = Personnage(perso)
tab1 = Tableau('fonds/fond_glacier.png', 1, 0, o, 25,675,960,990,0,1000)
tab2 = Tableau('fonds/fond_glacier.png', 1, 1, o,  25,675,960,990,0,1000 )
tab3 = Tableau('fonds/fond_glacier.png', 1, 2,  o, 25,505,960,990,0,1000 )
tab4 = Tableau('fonds/fond_glacier.png', 1, 3,  o, 25,652,960,990,0,1000 )
tab5 = Tableau('fonds/fond_glacier.png', 1, 4,  o, 25,675,960,990,0,1000 )
tab6 = Tableau('fonds/fond_glacier.png', 1, 5,  o, 25,52,945,990,0,1000 )
tab7 = Tableau('fonds/fond_glacier.png', 1, 6,  o, 25,52,945,990,0,1000 )
tab8 = Tableau('fonds/fond_glacier.png', 1, 7,  o, 25,405,945,990,0,1000 )
tab9 = Tableau('fonds/fond_glacier.png', 1, 8,  o, 25,505,945,990,0,1000 )
tab10 = Tableau('fonds/fond_glacier.png', 1, 9,  o, 25,505,945,990,0,1000 )
tab11 = Tableau('fonds/fond_glacier.png', 1, 10,  o, 25,60,945,990,0,1000 )
tab12 = Tableau('fonds/fond_glacier.png', 1, 11,  o, 25,635,945,990,0,1000 )
tab13 = Tableau('fonds/fond_glacier.png', 1, 12,  o, 25,545,945,990,0,1000 )
tab14 = Tableau('fonds/fond_glacier.png', 1, 13,  o, 25,125,945,990,0,1000 )
tab15 = Tableau('fonds/fond_glacier.png', 1, 14,  o, 25,670,945,990,0,1000 )
...
pygame.mixer.music.load("music/musique_glace.mp3")
